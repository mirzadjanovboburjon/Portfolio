...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_jnxit7k", "template_j4wzelm", formRef.current, {
        publicKey: "JuGlTxxFax7yjvJml",
      })
      .then(
        () => {
          setSuccess(true);
  ...
  return (
    ...
    >
      ...
      <motion.div className="about-containers contact-container">
        <motion.div className="formContainer">
          <motion.div className="article-container textContainer">
            <motion.div className="article" variants={variants}>
              <h2>Address</h2>
              <p>동대문구 망우로 18다길 13-8</p>
            </motion.div>
            <motion.div className="article" variants={variants}>
              <h2>E-mail</h2>
              <p>mirzadjanovboburjon@gmail.com</p>
            </motion.div>
            <motion.div className="article" variants={variants}>
              <h2>Phone</h2>
              <p>010-2975-2045</p>
        ...
        <motion.div className="formContainer">
          {/* <motion.div className="article-container "> */}
          <motion.div
            className="phoneSvg"
            initial={{ opacity: 1 }}
          ...
          >
            ...
            <textarea
              ...
              id="message"
            />
            <button className="btn-color-2">Submit</button>
            {error && "Error"}
            {success && "Success"}
          </motion.form>
        </motion.div>
